# ==========================================================
# STREAMLIT VIDEO QA SYSTEM - HYBRID V6 - V3-STYLE PROVEN MODEL LOADING
# ==========================================================
...
import app_core_v6 as core
import binary_ensemble

from app_core_v6 import (
    DEVICE,
    MULTITASK_MODEL_DIR,
    SUMMARY_CHECKPOINT,
    FRAMES,
...
def load_all_models():
    try:
        ...
        with st.spinner(
            ...
            progress("10/10 Loading binary anomaly detection ensemble...")
            models["binary_ensemble"] = (
                binary_ensemble.load_binary_models(
                    DEVICE
                )
            )
            progress("READY: All V6 hybrid models loaded successfully.")
